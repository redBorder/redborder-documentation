...
!!! info "Note..."
        This button is active only if SSO service is active too.
        If you just activate SSO service, you have to wait some minutes before using it until the service is all up and the file is generated and ready to download. 
