...
* Type: Standard
* Main changes: redborder-webui, redborder-intrusion
...
* \#20864 [cookbook-barnyard2] Moving an IPS sensor on sensor tree from a organization to a namespace doesn't remove the organization.
